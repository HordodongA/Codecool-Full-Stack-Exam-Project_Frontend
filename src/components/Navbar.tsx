...
import { Center, Flex, VStack, Heading, Text, Avatar, Menu, MenuButton, MenuList, MenuItem, Button } from '@chakra-ui/react'
...
const Navbar: FC = () => {
    ...
    return (
        <Flex as='nav' p='1.5% 2%' mb='1rem' width='100%' justify='space-between' bg='gray.300'>
