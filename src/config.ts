...
// export const landlordBackendUrl = "http://localhost:3003"       // When running locally
...
// export const landlordApiDocsUrl = "http://localhost:3003/api/docs"       // When running locally
